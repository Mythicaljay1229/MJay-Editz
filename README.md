...
<script>
  ...
  OneSignalDeferred.push(async function(OneSignal) {
    await OneSignal.init({
      appId: "b6d2c034-3433-473a-a481-0b68f4aae61d",
    });
  });
</script>
...
<iframe class="airtable-embed" src="https://airtable.com/embed/app1V6fqVzMbJAJXj/shruvdt2hzYjHW07E" frameborder="0" onmousewheel="" width="100%" height="800" style="background: transparent; border: 1px solid #ccc;"></iframe>
  <p>comment, vote and visit the site often to get points and earn badges</p>
